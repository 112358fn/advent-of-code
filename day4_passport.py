...
class TestPassportCheck(unittest.TestCase):
    def setUp(self):
    ...
    def test_reading_file(self):
        passports = extract_passports("day4_test_data.txt")
    ...
    def test_reading_real_file(self):
        passports = extract_passports("day4_passports_data.txt")
        self.assertEqual(
            passports[-1],
